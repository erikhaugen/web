 ...
 * 
 */
package com.livescribe.aws.login.config;
 ...
 * @version 1.0
 */
public class LoginServiceDataSource extends SimpleDriverDataSource implements AppConstants {
